...
| বিষয় | বিবরণ |
|--------|--------|
| **ফাইল আপলোড** | ইমেজ `public/uploads` এ সেভ হয়। কোনো রিডিপ্লয়/রিবিল্ডে এই ফোল্ডার রিসেট হতে পারে। দীর্ঘমেয়াদে চাইলে Hostinger Object Storage বা বাহিরের স্টোরেজ (যেমন S3) ব্যবহার করা ভালো। |
